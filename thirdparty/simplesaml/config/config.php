...
// echo getcwd();
$_segments = explode('/', getcwd()); $_segment = array_pop($_segments);
switch($_segment) {
	case 'www': $_path = '../../../code/sspConfigLoader.php'; break;
	case 'admin': $_path = '../../../../code/sspConfigLoader.php'; break;
	case 'sapphire': $_path = '../shibboleth/code/sspConfigLoader.php'; break;
	case 'example-simple': $_path = '../../../../../shibboleth/code/sspConfigLoader.php'; break;
}
include_once($_path);
...
$config = array (
	 ...
	 */
	'baseurlpath'           => SspConfigLoader::get_env_conf('config', 'baseurlpath'),
	'certdir'               => 'cert/',
	'loggingdir'            => 'log/',
	'datadir'               => 'data/',
	 ...
	 */
	'secretsalt' => SspConfigLoader::get_env_conf('config', 'secretsalt'),
	 ...
	 */
	'technicalcontact_name'     => SspConfigLoader::get_env_conf('config', 'technicalcontact_name'),
	'technicalcontact_email'    => SspConfigLoader::get_env_conf('config', 'technicalcontact_email'),
	 ...
	 */
	'timezone' => SspConfigLoader::get_default_or_conf(null, 'config', 'timezone'),
	 ...
	 */
	'idpdisco.enableremember' => SspConfigLoader::get_default_or_conf(false, 'config', 'useDiscoService') ? true : false,
	 ...
	 *     ),
	 */
	'metadata.sources' => SspConfigLoader::get_env_conf('config', 'metadata.sources'),
