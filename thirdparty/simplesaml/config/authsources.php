...
$config = array(
	...
	'default-sp' => array(
		...
		'entityID' => SspConfigLoader::get_default_or_conf(null, 'config', 'default-sp', 'entityID'),
		...
		'discoURL' => SspConfigLoader::get_default_or_conf(null, 'config', 'default-sp', 'useDiscoService') ?
			SimpleSAML_Module::getModuleURL('discopower/disco.php') :
			NULL,

		'privatekey' => SspConfigLoader::get_default_or_conf('server.pem', 'config', 'default-sp', 'privatekey'),
		'certificate' => SspConfigLoader::get_default_or_conf('server.crt', 'config', 'default-sp', 'certificate'),
